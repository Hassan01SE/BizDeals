            ...
            <Container fluid>
                ...
                <Row>
                    <div>
                        ...
                        <p>
                            <span><b>Disclaimer:</b></span> When purchasing a business through our platform, <b>please be aware that a token payment of 30% of the business's value will be required.</b> Additionally, BizDeal, as the provider of the platform facilitating the buying and selling of businesses, <b>will retain a share of 20% from the total payment amount after successful business transfer of ownership.</b> It's important to consider these factors and evaluate the overall cost before proceeding with a purchase. We recommend conducting thorough research and seeking professional advice to make informed decisions.
                        </p>
                    </div>
                </Row>
                <Row>
                    <Col className=' mt-3 mb-3' style={{ width: '100%' }}>
                    ...
                    <Col className=' mt-3 mb-3' style={{ width: '100%', borderRadius: '5%' }}>
